...
AssetHandle<Material> WaterBodyComponent::getMaterial()
{
	if (!entity.valid())
	{
	...
	AssetHandle<Material> mat = meshRenderer.getMaterialBySlot(0); // A water body plane only has single material
	return mat;
}
