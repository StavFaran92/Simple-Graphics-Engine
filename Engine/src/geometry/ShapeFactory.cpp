...
Entity ShapeFactory::createBoxEntity(SGE_Regsitry* registry)
{
	...
	AssetHandle<MeshGroupAsset> mesh = BuiltInAssets::getByName<MeshGroup>(SGE_MESH_BOX);
...
Entity ShapeFactory::createQuad(SGE_Regsitry* registry)
{
	...
	AssetHandle<MeshGroupAsset> mesh = BuiltInAssets::getByName<MeshGroup>(SGE_MESH_QUAD);
	entity.addComponent<MeshRendererComponent>(mesh);
	return entity;
}
...
Entity ShapeFactory::createSphere(SGE_Regsitry* registry)
{
	...
	AssetHandle<MeshGroupAsset> mesh = BuiltInAssets::getByName<MeshGroup>(SGE_MESH_SPHERE);
	entity.addComponent<MeshRendererComponent>(mesh);
	return entity;
}
