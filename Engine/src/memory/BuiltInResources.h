...
const std::string SGE_RESOURCE_SHADER_BONE_TRANSFORM_SINGLE_THREAD_PER_INSTANCE_COMPUTE = "SGE_RESOURCE_SHADER_BONE_TRANSFORM_SINGLE_THREAD_PER_INSTANCE_COMPUTE";
