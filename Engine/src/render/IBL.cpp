...
TextureResourceRef IBL::generateIrradianceMap(TextureResourceRef environmentMap)
{
...
TextureResourceRef IBL::generatePrefilterEnvMap(TextureResourceRef environmentMap)
{
...
TextureResourceRef IBL::generateBRDFIntegrationLUT()
{
