...
void ForwardRenderer::enableWireframeMode(bool enable)
{
...
void ForwardRenderer::renderSceneNonOpaque(Scene* scene)
{
    auto graphics = Engine::get()->getSubSystem<Graphics>();
...
void ForwardRenderer::setUniforms()
{
...
void ForwardRenderer::renderDebugData(Scene* scene)
{
    auto graphics = Engine::get()->getSubSystem<Graphics>();
...
void ForwardRenderer::renderSceneUsingCustomShader(Scene* scene)
{
