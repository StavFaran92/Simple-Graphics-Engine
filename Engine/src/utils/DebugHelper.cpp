...
DebugHelper::DebugHelper()
{
	...
	m_pointShader = Shader::create(SGE_ROOT_DIR + "Resources/Engine/Shaders/PointDebugShader.glsl");
	m_lineShader = Shader::create(SGE_ROOT_DIR + "Resources/Engine/Shaders/LineDebugShader.glsl");
}
