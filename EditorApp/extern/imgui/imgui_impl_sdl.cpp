...
//  2020-05-25: Misc: Report a zero display-numOfVertices when window is minimized, to be consistent with other backends.
...
void ImGui_ImplSDL2_NewFrame()
{
    ...
    // Setup display numOfVertices (every frame to accommodate for window resizing)
    int w, h;
